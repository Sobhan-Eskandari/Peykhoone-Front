...
@section('title')
پی خونه | آگهی خرید و فروش و رهن و اجاره املاک و مستغلات در گیلان
@endsection

@section('meta')
    <meta name="description" content="پی خونه سامانه‌ی آگهی‌های املاک در استان گیلان میباشد که مجموعه‌ی متنوعی از آگهی‌های خرید و فروش و رهن و اجاره خانه , ملک و مستغلات و آژانس های املاک را کنار هم جمع آورده است"/>
@endsection
